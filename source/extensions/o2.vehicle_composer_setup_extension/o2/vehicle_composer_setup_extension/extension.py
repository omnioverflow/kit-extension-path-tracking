...
DATA_PATH = Path(
    carb.tokens.get_tokens_interface().resolve("${o2.vehicle_composer_setup_extension}")
)
...
class VehicleComposerSetupExtension(omni.ext.IExt):
        ...
        self._menu_layout = [
            ...
            MenuLayout.Menu(
                ...
                [
                    ...
                    MenuLayout.Item(
                        "UI Toggle Visibility", source="Window/UI Toggle Visibility"
                    ),
