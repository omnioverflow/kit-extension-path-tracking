...
class ColorMap:
    ...
    """
    FORWARD_LINE       = DebugColor.RED.value
    UP_LINE            = DebugColor.GREEN.value
    FRONT_AXLE_LINE      = DebugColor.CHARTREUSE.value
    REAR_AXLE_LINE       = DebugColor.LIME.value
    VEHICLE_HEADING_LINE = DebugColor.SPRING_GREEN.value
    TRAJECTORY_LINE      = DebugColor.MEDIUM_SPRING_GREEN.value
    LOOKAHEAD_LINE       = DebugColor.PALE_GREEN.value
    DESTINATION_POINT    = DebugColor.SEA_GREEN.value
    PATH_TO_DEST_LINE    = DebugColor.FOREST_GREEN.value
    STEERING_LEFT        = DebugColor.DARK_OLIVE_GREEN.value
    STEERING_RIGHT       = DebugColor.CHARTREUSE.value
    TEXT_OVERLAY         = DebugColor.WHITE.value
    DEBUG_BOUNDING_BOX   = DebugColor.GREEN.value
...
class DebugDrawMode(enum.IntEnum):
    """
...
class DebugRenderer():
    ...
    def draw_vehicle_debug(self, vehicle, trajectory, front_axle_pos, rear_axle_pos, forward, up):
        ...
        self._debug_draw.draw_line(
            carb.Float3(x, y, z),
            ColorMap.FORWARD_LINE, LineThicknessMap.FORWARD_LINE,
        ...
        self._debug_draw.draw_line(
            carb.Float3(x, y, z),
            ColorMap.UP_LINE, LineThicknessMap.UP_LINE,
        ...
        if DebugDrawState().is_verbose_debug():
            ...
            self._debug_draw.draw_line(
                ...
                ColorMap.FRONT_AXLE_LINE, LineThicknessMap.FRONT_AXLE_LINE,
            ...
            self._debug_draw.draw_line(
                ...
                ColorMap.REAR_AXLE_LINE, LineThicknessMap.REAR_AXLE_LINE,
